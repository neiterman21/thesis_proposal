...
\thesistitle{My Cool Algorithm 101} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Prof. AAA \textsc{BBB}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{CCC \textsc{DDD}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
